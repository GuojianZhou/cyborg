...
def load_vmlu_vendor_driver():
    ...
    for m in modules:
        try:
            ...
            LOG.debug("Successfully loaded VMLU vendor driver: %s." % m)
        except ImportError as e:
            LOG.error("Failed to load VMLU vendor driver: %s. Details: %s"
                      % (m, e))


load_vmlu_vendor_driver()
